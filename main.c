...
S310121-R220721 - IOS - I/O Subsystem for the 68008 CPU (8MHz)
 
Supported HW ref: A091020, A091020-R140221 (68k-MBC)
...
Compiled with MPLABX v5.45 + XC8 v2.32 + MCC v5.0.1
...
// ------------------------------------------------------------------------------
//
// Hardware definitions for A091020 
//
// ------------------------------------------------------------------------------
...
const uint8_t           maxDiskSet   = 1;           // Number of configured Disk Sets
...
uint8_t                 bufferSD[512];              // I/O buffer for SD disk operations (store a 512 bytes logical sector)
...
char *                  pchar;                      // Used for the Autobboot boot mode
...
inline void execWriteOpcode()
{
  ...
  // Execute the requested I/O WRITE Opcode. The 0xFF value is reserved as "No operation".
  {
    ...
    case  0x02:
      ...
      // NOTE 2: Currently the only event that can set the IPL1 signal is the "Serial 1 Rx" (a char is present 
      //         on the read buffer).
